                                ...
                                <TouchableOpacity 
                                      ...
                                      <View style={{backgroundColor:"white",flexDirection: 'column',justifyContent: 'center',alignItems: 'flex-start',width:0.8*w,height:80,marginBottom:2}}>
                                          ...
                                          <View style={{backgroundColor:"white",flexDirection: 'row',justifyContent: 'flex-start',alignItems: 'center',width:w,height:45,marginBottom:2}}>
                                                  <Text style={{fontSize: 16,marginBottom:5,lineHeight:45,color:'#D32F2E'}}>记不清{glCategoryCountInfo[this.state.upperCategory+'-'+LevelName+'-记不清count']}</Text>
                                                  <Text style={{fontSize: 16,marginBottom:5,lineHeight:45,color:'#435A62'}}>    有点印象{glCategoryCountInfo[this.state.upperCategory+'-'+LevelName+'-有点印象count']}</Text>
                                                  <Text style={{fontSize: 16,marginBottom:5,lineHeight:45,color:'#4BAF4F'}}>    记住了{glCategoryCountInfo[this.state.upperCategory+'-'+LevelName+'-记住了count']}</Text>
                                                  <Text style={{fontSize: 16,marginBottom:5,lineHeight:45,color:'#01A9F2'}}>    忘不了{glCategoryCountInfo[this.state.upperCategory+'-'+LevelName+'-忘不了count']}</Text>
                                            </View>                       
